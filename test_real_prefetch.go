...
func main() {
	...
	fmt.Println("\n✓ All domains should now be in prefetch queue")
	fmt.Println()
	...
	fmt.Println("\n✓ Domain added to prefetch queue")
	...
	fmt.Println()
	fmt.Println("Summary:")
	fmt.Println("✓ Domains were queried and cached")
	fmt.Println("✓ Heat tracking triggered prefetch queue entry")
	fmt.Println("✓ Prefetch scheduler monitored cache entries")
	fmt.Println("✓ Inactive domains were removed from queue")
	fmt.Println("✓ Cache remained fresh throughout the test")
}
